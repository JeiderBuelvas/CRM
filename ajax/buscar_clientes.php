...
if ($action == 'ajax') {
    ...
    $per_page = 10; // Cuántos registros quieres mostrar
    $adjacents = 4; // Espacio entre páginas después de un número de adyacentes
                        ...
                        <tr>
                            ...
                            <td class='text-right'>
                                <span class="pull-right">
                                    <a href="#" class='btn btn-primary' title='Editar cliente' onclick="obtener_datos('<?php echo $id_cliente; ?>');" data-toggle="modal" data-target="#myModal2">
                                        <i class="glyphicon glyphicon-edit"></i>
                                    </a>
                                    <a href="#" class='btn btn-danger' title='Borrar cliente' onclick="eliminar('<?php echo $id_cliente; ?>')">
