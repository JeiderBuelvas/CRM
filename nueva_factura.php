        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" id="datos_factura">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <select class='form-control input-sm' id="condiciones">
                                ...
                                <option value="3">30 Días Fecha Facturada</option>
                    ...
                    <div class="form-group row">
                        <label for="nota" class="col-md-1 control-label">Historial de Visitas</label>
                        <div class="col-md-3">
                            <textarea class="form-control input-sm" id="nota" placeholder="Escribe tu observación...."></textarea>
                        </div>
                        <label for="tiempo_entrega" class="col-md-1 control-label">Tiempo</label>
                        <div class="col-md-7">
                            <textarea class="form-control input-sm" name="tiempo_entrega" id="tiempo_entrega" placeholder="Tiempo de Entrega..."></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="pull-right">
                            ...
                            #nuevoProducto">
                                <span class="glyphicon glyphicon-plus"></span> Adjutar archivos
                            </button>
                            <button type="button" class="" data-toggle="modal" data-target="
                            #nuevoProducto">
